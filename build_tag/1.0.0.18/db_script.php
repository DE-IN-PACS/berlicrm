...
echo 'module update Mailchimp start<br>';
...
echo 'module update Mailchimp done <br>';

 
echo "<br>update Tag version to 18. ";
$query = "UPDATE `vtiger_version` SET `tag_version` = 'berlicrm-1.0.0.18'";
