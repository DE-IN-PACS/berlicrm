...
<div class="modelContainer" style="min-width: 800px;">
    ...
    <form class="form-horizontal" name="contactsyncsettings">
        ...
        <input id="google_fields" type="hidden" value='{json_encode($GOOGLE_FIELDS)}' />
        <div class="modal-body">
            ...
            <div class="btn-group pull-right">
                ...
                <ul class="dropdown-menu dropdown-menu-left" role="menu">
                    <li class="addCustomFieldMapping" data-type="email" data-vtigerfields='{json_encode($VTIGER_EMAIL_FIELDS)}'><a>{vtranslate('LBL_EMAIL',$MODULENAME)}</a></li>
                    <li class="addCustomFieldMapping" data-type="phone" data-vtigerfields='{json_encode($VTIGER_PHONE_FIELDS)}'><a>{vtranslate('LBL_PHONE',$MODULENAME)}</a></li>
                    <li class="addCustomFieldMapping" data-type="url" data-vtigerfields='{json_encode($VTIGER_URL_FIELDS)}'><a>{vtranslate('LBL_URL',$MODULENAME)}</a></li>
                    <li class="divider"></li>
                    <li class="addCustomFieldMapping" data-type="custom" data-vtigerfields='{json_encode($VTIGER_OTHER_FIELDS)}'><a>{vtranslate('LBL_CUSTOM',$MODULENAME)}</a></li>
                </ul>
            </div>
            <div class="row-fluid">
                <div class="control-group">
