...
{strip}
    {if !empty($CUSTOM_VIEWS)}
        <div class="relatedContainer listViewPageDiv margin0px">
            ...
            <input type="hidden" id="selectedIds" name="selectedIds" data-selected-ids={json_encode($SELECTED_IDS)} />
            <input type="hidden" id="excludedIds" name="excludedIds" data-excluded-ids={json_encode($EXCLUDED_IDS)} />
