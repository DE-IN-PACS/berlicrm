...
<div class="filterContainer">
	...
	<input type="hidden" name="advanceFilterOpsByFieldType" data-value='{json_encode($ADVANCED_FILTER_OPTIONS_BY_TYPE)}' />
	{foreach key=ADVANCE_FILTER_OPTION_KEY item=ADVANCE_FILTER_OPTION from=$ADVANCED_FILTER_OPTIONS}
		{$ADVANCED_FILTER_OPTIONS[$ADVANCE_FILTER_OPTION_KEY] = {vtranslate($ADVANCE_FILTER_OPTION, $QUALIFIED_MODULE)}|escape}
	{/foreach}
	<input type=hidden name="advanceFilterOptions" data-value='{json_encode($ADVANCED_FILTER_OPTIONS)}' />
