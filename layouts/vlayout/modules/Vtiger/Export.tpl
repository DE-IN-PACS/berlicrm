			...
			<div class="span8">
				...
				<div class="well exportContents marginLeftZero">
					...
					<div class="textAlignCenter">
						<span style="padding-left:15px;padding-right:15px;">{vtranslate('LBL_CSV_FORMAT',$MODULE)}&nbsp;<input type="radio" name="export_type" value="text/csv" checked="checked" /></span>
						<span  style="padding-left:15px;padding-right:15px;">{vtranslate('LBL_EXCEL_FORMAT',$MODULE)}&nbsp;<input type="radio" name="export_type" value="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" /></span>
					</div>
					<br>
					<div class="textAlignCenter">
